...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['100K pageviews/mo', '10 font families', 'Basic subsetting', 'Community support'] },
  { name: 'Pro', price: '$29/mo', features: ['5M pageviews/mo', 'Unlimited fonts', 'Auto-subsetting', 'Usage analytics', 'Priority CDN'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited pageviews', 'Custom domain', 'Priority cache', 'SLA guarantee', 'Dedicated support'] },
];
